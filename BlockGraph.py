...
class BlockGraphicsItem(GraphicsObject):
...
#class NodeGraphicsItem(GraphicsObject):
    ...
    def setBrush(self, a,b,c,d):
        self.brush = fn.mkBrush(a,b,c,d)
        self.update()
    ...
    def setbounds(self,l1,l2):
        self.bounds = QtCore.QRectF(0, 0, l1,l2)
